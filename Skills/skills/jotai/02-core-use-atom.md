...
**Note:** as mentioned in the _atom_ section, referential equality is important when creating atoms, so you need to handle it properly otherwise it can cause infinite loops.
...
const Component = () => {
  ...
  // ✅ This is also correct for derived atoms
